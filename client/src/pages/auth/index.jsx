...
const Auth = () => {
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex items-center justify-center">
      <div className="h-[80vh] bg-white border-2 border-white text-opacity-90 shadow-2xl w-[80vw] md:w-[90vw] lg:w-[70vw] xl:w-[60vw] rounded-3xl grid xl:grid-cols-2 md:flex justify-center">
                ...
                <TabsList className="bg-transparent rounded-none w-full">
                  ...
                  <TabsTrigger
                    className="data-[state=active]:bg-transparent
                     ...
                     border-b-2 rounded-none w-full 
